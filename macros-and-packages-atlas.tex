...
\iffalse
% IBM palette
\definecolor{c1}{RGB}{100, 143, 255}
\definecolor{c2}{RGB}{0, 114, 178}
\definecolor{c3}{RGB}{220,38,127}
\definecolor{c4}{RGB}{254,97,0}
\definecolor{c5}{RGB}{255, 176, 0}
\fi

% Okabe & Ito palette
\definecolor{c1}{RGB}{100, 143, 255}
\definecolor{c2}{RGB}{0, 158, 115}
\definecolor{c3}{RGB}{204,121,167}
\definecolor{c4}{RGB}{213,94,0}
\definecolor{c5}{RGB}{0,114,178}
...
\pretocmd{\parttoc}{\begingroup\pagestyle{noheader}}{}{}
\apptocmd{\parttoc}{\endgroup}{}{}
...
\renewcommand{\tr}{\on{tr}}
\newcommand{\vol}{\on{vol}}
\newcommand{\cond}{\on{cond}}
\newcommand{\sgn}{\on{sgn}}
\renewcommand{\char}{\on{char}}
\newcommand{\Frac}{\on{Frac}}
\newcommand{\card}{\on{card}}
\newcommand{\intr}{\on{int}}
\newcommand{\extr}{\on{ext}}
...
% groups and sets
\newcommand{\Moeb}{\tn{Möb}}
\newcommand{\GL}{\tn{GL}}
\newcommand{\PGL}{\tn{PGL}}
\newcommand{\SO}{\tn{SO}}
\newcommand{\SL}{\tn{SL}}
\newcommand{\PSL}{\tn{PSL}}
\newcommand{\Hess}[1]{\tn{Hess}(#1)}
