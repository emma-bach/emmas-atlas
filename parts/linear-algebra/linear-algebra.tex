...
\end{importantdefinition}
\begin{exercise}
	\label{th:realfunctionalgebra}
	\begin{enumerate}
		\item Show that every commutative unital ring trivially forms an algebra over itself.
		\item Show that the set $C(M, \bR)$ of continuous functions from a metric space $M$ into $\bR$ forms a commutative associative unital algebra under pointwise addition and multiplication, with the constant function $\boldone_\bR$ as the identity of multiplication.
	\end{enumerate}
\end{exercise}
