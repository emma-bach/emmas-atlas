...
\end{importantdefinition}
\begin{exercise}
	Show that T1 implies T0.
\end{exercise}
\begin{exercise}
	Find a space that is T0, but not T1.
\end{exercise}
\begin{exercise}
...
\end{exercise}
\begin{exercise}
	Let $(X, \cO)$ be a topological space. Then $(X, \cO)$ is Hausdorff if and only if every convergent filter has a unique limit.
\end{exercise}
\begin{importanttheorem}{Characterization of Hausdorff spaces by diagonals}{}
	Let $(X, \cO)$ be a topological space. Then $(X, \cO)$ is Hausdorff iff. the diagonal
	\begin{align*}
...
\end{proof}
\begin{theorem}
	Let $(X, \cO)$ be a topological space. Then $(X, \cO)$ is Hausdorff iff. every point is the intersection of the closures of all of its neighbourhoods:
	\begin{align*}
...
\end{exercise}
Showing that T4 implies T3 is not an easy task - this statement is \tit{Urysohn's Lemma}, which we will prove later in this chapter after a lot of preparation.	
