...
\begin{importantdefinition}{Separation Axioms}{}
	Let $(X, \cO)$ be a topological space. Then we call $(X,\cO)$:
	\begin{enumerate}
		\item \tib{T0}, if for every pair of points $x,y \in X$, one of them has a neighbourhood that isn't a neighbourhood of the other.
		\item \tib{T1}, if for every pair of points, both of them have neighbourhoods not containing the other.
		\item \tib{T2} or \tib{Hausdorff´}, if for every pair of points, both of them have  disjoint neighbourhoods not containing the other.
		\item
		\tib{regular}, if every point can be housed orf from any closed set not containing it by disjoint open sets.
		\item \tib{T3} or \tib{regular Hausdorff}, if it is regular and Hausdorff.
		\item \tib{completely regular}, If every point can be separated from any closed set not containing it by a continuous function:
		\begin{align*}
		...
		\end{align*}
		\item \tib{T3a}, \tib{T3$\frac{1}{2}$}, or \tib{completely regular Hausdorff}, if it is completely regular and Hausdorff.
		\item \tib{normal}, if every pair of closed sets can be housed orf from each other by disjoint neighbourhoods.
		\item \tib{Normal Hausdorff}, if it is normal and Hausdorff.
	\end{enumerate}
