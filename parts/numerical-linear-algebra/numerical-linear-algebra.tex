...
\end{exercise}
\begin{importantdefinition}{Stability Indicator}{}
	The \tib{stability indicator} of a numerical algorithm $\tPhi_\epsilon$ with rounding accuracy $\epsilon$ is
	\begin{align*}
		\inf \lr{\sigma \geq 0 \mid \exists \delta > 0 : \forall \epsilon \leq \delta : \epsilon_{\tPhi_\epsilon} \leq \sigma \kappa_{\Phi(x)}\epsilon} \cdot \epsilon
	\end{align*}
\end{importantdefinition}
